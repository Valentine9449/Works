    ...
    def create_task(self):
        ...
        for key, lst in data.items():
            ...
            for elements in lst:
                ...
                firstName = elements.get('firstName')
                lastName = elements.get('lastName')
                ...
                lst_tpl =  [(tpl[0], tpl[1].__class__.__name__) for tpl in elements.items()]
                for tpl in lst_tpl:
                    value, typeValue = tpl

                    custom_value = d_types.get(typeValue)
